...
function deploy() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(yield util_1.execute(`ls`, constants_1.workspace));
        console.log(yield util_1.execute(`ls ${constants_1.build}`, constants_1.workspace));
        yield util_1.execute(`cp -rf ~${constants_1.workspace}/${constants_1.build} ${temporaryDeploymentDirectory}`, constants_1.workspace);
