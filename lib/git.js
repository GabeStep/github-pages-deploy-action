...
function generateBranch() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield util_1.execute(`git commit --allow-empty -m "Initial ${constants_1.action.branch} branch creation"`, constants_1.workspace);
...
function deploy() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const branchExists = Number(yield util_1.execute(`git ls-remote --heads ${constants_1.repositoryPath} ${constants_1.action.branch} | wc -l`, constants_1.workspace));
            if (!branchExists) {
            ...
            yield util_1.execute(`git commit -m "Deploying to ${constants_1.action.branch} from ${constants_1.action.baseBranch || 'master'} ${process.env.GITHUB_SHA}"`, temporaryDeploymentDirectory);
