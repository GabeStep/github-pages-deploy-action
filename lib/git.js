...
function deploy() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield util_1.execute(`git push $REPOSITORY_PATH ${'`'}git subtree split --prefix $FOLDER ${constants_1.action.baseBranch || 'master'}${'`'}:${constants_1.action.branch} --force`, constants_1.workspace);
